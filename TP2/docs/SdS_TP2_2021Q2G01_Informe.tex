...
El esquema del sistema (ver Figura 3) consta de una grilla cuyo lado tiene longitud \emph{L}, en la cual interactúan partículas con velocidad constante \emph{v} e interactúan dentro un radio \emph{r}.
...
\begin{itemize}
    ...
    \item dimensión de la grilla MxM (Variable). En particular, este parámetro se utiliza en el \emph{Cell Index Method} para calcular los vecinos teniendo en cuenta condiciones de de contorno periódicas [1]
\end{itemize}
...
\pagebreak
\begin{figure}[h]
\includegraphics[scale=0.3]{noise_N300d06n02.png}
\centering 
\caption{Capturas de los frames 0, 180 y 500 de una Animación con N=300; densidad=0.6 y ruido=0.2}
\end{figure}

\begin{figure}[h]
\includegraphics[scale=0.3]{noise_N300d06n1_5.png}
\centering 
\caption{Capturas de los frames 0, 600 y 1200 de una Animación con N=300; densidad=0.6 y ruido=1.5}
\end{figure}

\pagebreak
\begin{figure}[h]
\includegraphics[scale=0.3]{noise_N300D06N5.png}
\centering 
\caption{Capturas de los frames 0, 1000 y 1200 de una Animación con N=300; densidad=0.6 y ruido=1.5}
\end{figure}
...
Tomando como base los resultados obtenidos tras a partir de las simulaciones, se llegó a la 

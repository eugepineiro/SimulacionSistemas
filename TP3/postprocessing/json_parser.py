from models import ar.edu.itba.ss.ExtendedEvent, ar.edu.itba.ss.Event, ar.edu.itba.ss.WallCollisionEvent, ar.edu.itba.ss.ParticleCollisionEvent, ar.edu.itba.ss.Wall, ar.edu.itba.ss.ar.edu.itba.ss.ar.edu.itba.ss.models.VelocityParticle, ar.edu.itba.ss.ar.edu.itba.ss.models.ParticleType
...
def parse_extended_events(extended_events):
    ...
    for ev in extended_events:
        ...
        if event['type'] == 'WALL_COLLISION':
            ...
            particle = ar.edu.itba.ss.ar.edu.itba.ss.ar.edu.itba.ss.models.VelocityParticle(particle_raw['id'], particle_raw['x'], particle_raw['y'], particle_raw['radius'], particle_type, particle_raw['vx'], particle_raw['vy'], particle_raw['mass'], particle_raw['collisions'])
            ...
            particle1 = ar.edu.itba.ss.ar.edu.itba.ss.ar.edu.itba.ss.models.VelocityParticle(particle1_raw['id'], particle1_raw['x'], particle1_raw['y'], particle1_raw['radius'], particle1_type, particle1_raw['vx'], particle1_raw['vy'], particle1_raw['mass'], particle1_raw['collisions'])
            ...
            particle2 = ar.edu.itba.ss.ar.edu.itba.ss.ar.edu.itba.ss.models.VelocityParticle(particle2_raw['id'], particle2_raw['x'], particle2_raw['y'], particle2_raw['radius'], particle2_type, particle2_raw['vx'], particle2_raw['vy'], particle2_raw['mass'], particle2_raw['collisions'])
        ...
        for p in ev['frame']:
            ...
            particle = ar.edu.itba.ss.ar.edu.itba.ss.ar.edu.itba.ss.models.VelocityParticle(p['id'], p['x'], p['y'], p['radius'], p_type, p['vx'], p['vy'], p['mass'], p['collisions'])

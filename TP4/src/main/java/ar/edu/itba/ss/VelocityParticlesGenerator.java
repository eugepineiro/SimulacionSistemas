...
public class VelocityParticlesGenerator {
    ...
    public static List<ar.edu.itba.ss.models.VelocityParticle> generateRandomWaterParticles(int N, int L, Double fixedRadius, double minSpeed, double maxSpeed, Random r, double mass) {
    ...
    public static List<ar.edu.itba.ss.models.VelocityParticle> generateRandomWaterParticles(List<ar.edu.itba.ss.models.VelocityParticle> particles, long N, long L, Double fixedRadius, double minSpeed, double maxSpeed, Random r, double mass){
        ...
        for (long i = 0; i < N; i++) {
            ...
            generated.add(new ar.edu.itba.ss.models.VelocityParticle(ParticleType.SMALL, newParticle, newSpeed, angle, mass));
        }
    ...
    private static boolean allTestTrue(List<ar.edu.itba.ss.models.VelocityParticle> particles, Particle particle, BiPredicate<Particle, Particle> condition) {
        for (ar.edu.itba.ss.models.VelocityParticle p: particles)
